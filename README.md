...
| Sprint 2 | 已完成 | 段落评论、评论列表、小说标签、独立小说分类、分类页筛选、社区化阅读互动 |
...
如果你要使用独立小说分类字段，请继续导入：

```text
db/mysql/10_novel_category.sql
```
...
| 方法 | 路径 | 说明 |
| --- | --- | --- |
| GET | `/api/novels` | 小说列表，可带 `tag`、`category` 查询参数 |
